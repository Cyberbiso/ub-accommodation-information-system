...
@section('title', 'UB Onboarding System')

@section('content')
<!-- Hero Section -->
<div class="hero-gradient text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">Welcome to UB Onboarding</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition">
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('information.checklist') }}" class="text-red-800 hover:text-red-900 font-medium inline-flex items-center">
...
<div class="hero-gradient text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl mb-8 opacity-90">Join thousands of students who use UB Onboarding for a smooth transition.</p>
