...
<head>
    ...
    <title>@yield('title', 'UB Accommodation') - UB Accommodation Information System</title>
    ...
    <footer class="bg-gray-800 text-white py-12 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-lg font-semibold mb-4">UB Accommodation</h3>
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; {{ date('Y') }} UB Accommodation Information System. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
