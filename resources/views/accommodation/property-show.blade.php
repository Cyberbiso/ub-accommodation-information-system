    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Left Column - Details -->
                <div>
                    <h2 class="text-2xl font-bold mb-4 text-gray-900">Property Details</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="text-gray-800">{{ $property->address }}, {{ $property->city }}</div>
                        </div>

                        <div class="flex items-center">
                            <div class="w-32 text-gray-600">Property Type:</div>
                            <div class="capitalize text-gray-800">{{ $property->type }}</div>
                        </div>

                        <div class="flex items-center">
                            <div class="w-32 text-gray-600">Bedrooms:</div>
                            <div class="text-gray-800">{{ $property->bedrooms }}</div>
                        </div>

                        <div class="flex items-center">
                            <div class="w-32 text-gray-600">Bathrooms:</div>
                            <div class="text-gray-800">{{ $property->bathrooms }}</div>
                        </div>

                        @if($property->distance_to_campus_km)
                        <div class="flex items-center">
                            <div class="w-32 text-gray-600">Distance:</div>
                            <div class="text-gray-800">{{ $property->distance_to_campus_km }} km from campus</div>
                        </div>
                        @endif

                        <div class="flex items-center">
                            <div class="w-32 text-gray-600">Landlord:</div>
                            <div class="text-gray-800">{{ $property->landlord->name }}</div>
                        </div>

                        <div class="flex items-center">
                            <div class="w-32 text-gray-600">Available:</div>
                            <div class="text-gray-800">{{ $property->available_from?->format('d M Y') ?? 'Not set' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        <h3 class="text-lg font-semibold mb-2 text-gray-900">Amenities</h3>
                ...
                <div>
                    <h2 class="text-2xl font-bold mb-4 text-gray-900">Photos</h2>
